...
public class Parser {
	...
	public static boolean isValid(String s) {
		String[] stri = {"attribute","floatLit","then","else","not","=","while","dot","MEMBER","constructor","ARRSIZE","VarDec","ClassDec","Program","List","VariableList","RightExprList","ReptIndice","ArithExpr","relop","IDNEST","StatmentList","Factor","Variable","Statment","dot","type","sign","not","id","intLit","isa","class","function","visiblity","FParms"};
		for(int i=0;i<stri.length;i++) {
			if(stri[i].equals(s)) return true;
		}
		return false;
	}
	public static ArrayList<TreeNode> reverseList(ArrayList<TreeNode> list){
		int x = list.size();
	...
	static String[][] rules = {{"ST $","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","ST $","","","","","","","","ST $","",""},
			...
			{"","id A4 STATMTIDNEST ; B2","","while ( RELEXPR ) STATBLK ; D9","","","read ( VAR ) ;","write ( EXPR ) F1 ;","return ( EXPR ) F3 ;","if ( RELEXPR ) then STATBLK E3 else STATBLK E4 ; B4","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","",""},
			...
			{"","","EPS","","","EPS","","","","","","","","","EPS","EPS","EPS","EPS","EPS","","","MULOP FACTOR B7 RIGTEM","MULOP FACTOR B7 RIGTEM","MULOP FACTOR B7 RIGTEM","EPS","EPS","EPS","EPS","","","","","EPS","","","","","","","","","","","","","","","","","","EPS"},
			{"","","","","","","","","","","","","","","","","","","","","","*","/","and","","","","","","","","","","","","","","","","","","","","","","","","","","",""},
			{"","","EPS","","","EPS","","","","","","","","","EPS","EPS","EPS","EPS","EPS","","","","","","ADDOP TERM B8 RIGARIEXPR","ADDOP TERM B8 RIGARIEXPR","ADDOP TERM B8 RIGARIEXPR","EPS","","","","","EPS","","","","","","","","","","","","","","","","","","EPS"},
			{"","","","","","","","","","","","","","","","","","","","","","","","","+","-","or","","","","","","","","","","","","","","","","","","","","","","","",""},
